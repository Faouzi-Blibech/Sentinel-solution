> **Historical document.** A teammate's independent audit of commit `2121967`, written on
> 2026-09-20. It describes the repository as it was then and is kept as a record of the
> review. For current results, see [`docs/report/findings.md`](report/findings.md) and
> [`docs/report/responsible-ai.md`](report/responsible-ai.md).
